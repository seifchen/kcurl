...
var rootCmd = &cobra.Command{
	Use:   "kcurl",
	Short: "kcurl is request some url",
	Long:  `kcurl is request some url get ,post and print the detail request and response`,
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".kcurl" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".kcurl")
	}
